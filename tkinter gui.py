...
def mainMenu(): #layout for starting page / main menu
    ...
    image2 = Image.open('file.png')
    image2=image2.resize((50,30))
    image2 = image2.convert("RGBA")
    img2 = ImageTk.PhotoImage(image2)
    image3 = Image.open('safety.jpg')
    image3=image3.resize((60,60))
    img3 = ImageTk.PhotoImage(image3) #maybe add images, implementation is weird
