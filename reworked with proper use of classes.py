...
class App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title('KEEP ME SAFE - MAIN MENU')
...
class fileScan(tk.Frame):
    ...
    def create_widgets(self,frame,myFrame,secFrame,parent):
        ...
        mainMenu_button = tk.Button(myFrame,width=30,text='MAIN MENU',command=lambda:self.toMainMenu(parent))
...
class websiteScan(tk.Frame):
    ...
    def __init__(self,parent):
        ...
        clearTab(parent)
        root = parent
        parent.title("KEEPMESAFE - WEBSITE SCAN")
        frame = tk.Frame(root)
        frame.pack(fill=tk.BOTH,expand=True)
        myFrame = tk.Frame(frame)
    ...
    def create_widgets(self,frame,myFrame,parent):
        T = tk.Text(frame,padx=10,pady=10,wrap=tk.WORD)
...
class showAdvice(tk.Frame):
    ...
    def create_widgets(self,frame,parent):
        ...
        mainMenu_button = tk.Button(frame,width=30,text='MAIN MENU',command=lambda : self.toMainMenu(parent))
